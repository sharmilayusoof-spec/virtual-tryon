...
%%% image loading
%%%
V1 = imread('../project/code/zalando_affine_model/perceptual_stn_perc1.0/images/00005400-001012_0-mask_outputs.png');
V2 = imread('../project/code/zalando_affine_model/perceptual_stn_perc1.0/images/00005400-001012_0-prod_segment.png');

V1 = im2double(double(imfill(V1)>0));
% V2 = im2double(flipdim(V2,2));
V2 = im2double(V2);
...
if display_flag
   [x,y]=meshgrid(linspace(1,N2,10),linspace(1,N1,10));
   x=x(:);y=y(:);M=length(x);
end
